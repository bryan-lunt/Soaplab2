...
/**
 * A factory for OutputTypesJob instances.
 * <p>
 * 
 * @author <A HREF="mailto:martin.senger@gmail.com">Martin Senger</A>
 * @version $Id: HelloWorldJobFactory.java,v 1.1 2007/04/02 15:10:19 marsenger
 *          Exp $
 */

public class OutputTypesJobFactory implements JobFactory {

    /***************************************************************************
     * The default constructor.
     **************************************************************************/
    public OutputTypesJobFactory() {
    }
    ...
    public Job newInstance(String jobId, MetadataAccessor metadataAccessor,
        ...
        return new OutputTypesJob(jobId, metadataAccessor, reporter,

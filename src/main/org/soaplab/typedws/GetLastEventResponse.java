...
@XmlType(name = "getLastEventResponse", namespace = "http://soaplab.org/typedws", propOrder = {
    "event"
})
@XmlRootElement(name = "getLastEventResponse", namespace = "http://soaplab.org/typedws")

...
@XmlRootElement(name = "getResultSpecResponse", namespace = "http://org.soaplab.2")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getResultSpecResponse", namespace = "http://org.soaplab.2")
public class GetResultSpecResponse {

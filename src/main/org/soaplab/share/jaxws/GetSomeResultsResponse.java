...
@XmlRootElement(name = "getSomeResultsResponse", namespace = "http://org.soaplab.2")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getSomeResultsResponse", namespace = "http://org.soaplab.2")
public class GetSomeResultsResponse {
